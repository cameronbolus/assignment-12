...
var createCarRecord = function(make, model, year, plateNumber){

  if(arguments.length < 4){

    return "new record must have make, model, year, and license values";
  }
  if(typeof year !== typeof 0){

    return "3rd argument must be a Number";
  }

  if(typeof make !== typeof '' || typeof model !== typeof '' || typeof plateNumber !== typeof ''){

    return "1st, 2nd, and 4th arguments must be String";
  }else{
    var finalObject = {}
    finalObject = {"make": make, "model": model, "year": year, "license": plateNumber}
